...
export default async function HomePage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  const [games, facets, platforms, tags] = await Promise.all([libraryService.listGames(filters), libraryService.listGames(), libraryService.listPlatforms(), libraryService.listTags()]);
